...
<body id="page-top">
                ...
                <div class="container-fluid" style="font-size: 12px;">
                    ...
                    <form id="createForm" name="f1" onsubmit="multiply()">
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border border-2 borders w-25 border ">General Details</Details>
                            </legend>
                            <div class="control-group General bg-white shadow-sm p-4">
                                ...
                                <div class="row ">
                                    <div class="col-2 fs-4">
                                        ...
                                        <lebel style="font-size: 15px; color:black;">Shop / Organisation Name </lebel>
                                    </div>
                                    <div class="col-10">
                                ...
                                <div class="row mt-3 mb-3">
                                    ...
                                    <div class="col-4">
                                        <select class="bank_name h-20" id="Business_Type" name="Business_Type"
                        ...
                        <fieldset class="scheduler-border h-50">
                            <legend class="scheduler-border borders w-25 border ">Tenure</Details>
                            </legend>
                            <div class="control-group General bg-white shadow-sm p-4  ">
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border borders w-25 border ">ALL RISK </Details>
                            </legend>
                            <div class="control-group General bg-white  shadow-sm p-4  ">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-4">
                                        <input class="bank_name" value="92029222932000001" type="text">
                                    ...
                                    <div class="col-4">
                                        <select class="bank_name h-20" id="BUSINESS" value="" name="Business"
                                            style=" border-opacity: 0.7; height:30px;" required>
                                            <option value="">None</option>
                                            <option value="ALLRISK" name="ALLRISK">ALL RISK</option>
                                            <option value="BATTERY" name="BATTERY">ALL RISK PLUS THEFT </option>
                                        </select>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-4">
                                        <input class="bank_name" type="Number" value="" id="SumInsured"
                        ...
                        <button class="Calculate bg-gradient-primary fs-1 rounded-pill submit" onsubmit="multiply()"
                            onClick="multiplyBy()" style="position: absolute; margin-left:300px; font-size:15px"
                            type="submit" id="submit">Calculate Premium</button>
                    </form>
                    <center>
                        <a class="text-white" style="margin-left:100px; "
                        href="<?php echo site_url('Welcome/agent_secoundpage/') . $this->uri->segment(3); ?>"><button
                                class="bg-gradient-primary Next ml-3 Calculate  rounded-pill"
                                style="width:150px; margin-left:100px;  font-size:15px;"> Next</button></a>
                        <p class="mt-3" style="font-size: 15px; color:black;">Final Premium: - <span id="result"></span>
                            /- Rs</p>
                    </center>
    ...
    $("#submit").click(function(e) {
        ...
        var premium = $("#results").val();

        $.ajax({
            url: "<?php echo site_url('Welcome/agent_product'); ?>",
            type: 'POST',
            dataType: 'text',
            data: {
                SumInsured: SumInsured_id,
                Business: Business_id,
                bank: bank_id,
                Business_Type: Business_Types,
                Policy_Start: Policy_id,
                premium: premium,
            },
    ...
    function multiplyBy() {
        ...
        if (bank == "" || Business_Type == " " || date == "" || SumInsured == "" || Business == "") {
            ...
            if (num2 == 'ALLRISK') {
                ...
                document.getElementById("result").innerHTML = Math.round(num3);
