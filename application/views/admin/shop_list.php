                        ...
                        <div class="card-body">
                            ...
                            {  $i++;?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="" href="<?php echo site_url("Welcome/agent_product/").$row->id;?>">
                                                    <button type="button" class="btn btn-primary">Add</button>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="" href="<?php echo site_url("Welcome/agent_policy_list/").$row->shop_code;?>">
                                                   View
                                                    </a>
                                            </td>
                                            <td>
                                                ...
                                                <a class=""
                                                    href="<?php echo site_url("Welcome/edit_shop/").$row->id;?>">
