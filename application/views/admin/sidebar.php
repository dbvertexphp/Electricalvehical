            ...
            <div id="user_list" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                ...
                <div class="bg-white collapse-inner rounded">
                    ...
                    <a class="collapse-item " href="<?php echo site_url("Welcome/user_report");?>"><i
                            ...
                            class="fa fa-mobile pr-1" aria-hidden="true"></i>USER REPORT</a>

                            <a class="collapse-item " href="<?php echo site_url("Welcome/vehicle_user_report");?>"><i

                                 class="fa fa-motorcycle  pr-1" aria-hidden="true"></i>VEHICLE USER REPORT</a>
