                ...
                <div class="Vehicle_calculetor_input_hide" style="display:none;" >
                    <form class="needs-validation" method="post" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class=" col-md-6 mt-0">
                                <label for="Vehicle_Price" class=" post_input_lable"><b>Price</b></label>
                                <input type="number" class="form-control no-spinners" id="Vehicle_Price"
                                    name="Vehicle_Price" placeholder="Enter Price" maxlength="8"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    required>
                                <div class="invalid-feedback">
                                    Please Enter Price.
