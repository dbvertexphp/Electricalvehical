        ...
        <div class="row">
          <div class="col-md-6">
                ...
                <div class="d-grid gap-2 col-4 mx-auto">
                    <button class="btn rounded-5" type="submit" id="submit" style="background-color: #ffb600;color:white">View Price</button>
                   
                  </div>
                
                <p class ="mt-3 post_input_lable" style="font-size: 15px; color:black; text-align-last: center;">Final Premium: - <span id = "Final_Premium"></span> /- Rs</p>
              </form>
              <div class="d-grid gap-2 col-4 mx-auto" style="justify-items: center;">
                    <a href="<?php echo base_url();?>Fornt/buy_Premium"><button class="btn rounded-5" type="submit" id="submit" style="background-color: #ffb600;color:white">Buy Premium</button></a>
                  </div>
          </div>
          <div class="col-md-6">
                ...
                <div class="p fixede">
                    <div class="row finxed_row">
                        <div class="appdevcol col-md-6">
                            <img class="mobile_skin" style="filter: drop-shadow(7px 0px 10px #ccc);" src="<?php echo base_url();?>image/phone.png" alt="pahadiuncle_layout">
                        </div>
                        <div class="appdevcol col-md-6">
