...
<body class="">
                    ...
                    <form class="needs-validation" method="post" action="<?php echo base_url();?>Fornt/Vehicle_policy_form"
                        ...
                        <div class=" g-3">
                            ...
                            <fieldset class="border rounded-3 p-3 mt-2">
                                ...
                                <div class="row ">
                                    <div class="col-sm-4">
                                        <label for="firstName" class="form-label">Bank/Comp Name</label>
                        ...
                        <fieldset class="border rounded-3 p-3 mt-2">
                            ...
                            <div class="row ">
                                <div class="col-sm-4">
                                    ...
                                    <input type="date" class="form-control" id="Policy_Start" name="date"
                                        value="<?php echo date('Y-m-d'); ?>" placeholder="" value="" required readonly>
                                    <div class="invalid-feedback">
                        ...
                        <fieldset class="border rounded-3 p-3 mt-2">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="lastName" placeholder=""
                                        value="ELECTRIC VEHICLE" readonly>
                                    <div class="invalid-feedback">
                                        Valid last name is required.
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <input type="Number" class="form-control no-spinners" value="" id="SumInsured"
                                        name="SumInsured" placeholder="" value="" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="Number" class="form-control no-spinners" id="results" name="premium"
                        ...
                        <fieldset class="border rounded-3 p-3 mt-2">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-sm-4">
                                    <label for="state" class="form-label">Type Of Body</label>
                                    <select class="form-select" id="Type_Body" name="Type_Body" required>
                                        <option value="">Choose...</option>
                                ...
                                <div class="col-sm-4">
                                    <label for="lastName" class="form-label">Seting Capicity*</label>
                                    <input type="text" class="form-control" id="Seting_Capicity*" placeholder=""
                                        value="2" readonly>
                                    <div class="invalid-feedback">
                                        Valid Barnch Code is required.
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <label for="lastName" class="form-label">Tear Of Manufacturing*</label>
                                ...
                                <div class="col-sm-4">
                                    <label for="lastName" class="form-label">Battery No</label>
                                    <input type="text" class="form-control" name="Battery_No" id="Battery_No" value=""
                                        placeholder="Battery No" value="" required>
                                    <div class="invalid-feedback">
                                        Valid Battery No is required.
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <label for="lastName" class="form-label">Model No</label>
                                    <input type="text" class="form-control" value="" name="Model_No" id="Model_No"
                                ...
                                <div class="col-sm-4">
                                    <label for="lastName" class="form-label">Chassis No</label>
                                    <input type="text" class="form-control" id="Chassis_No" name="Chassis_No"
                                        placeholder="Chassis No" value="" required>
                                    <div class="invalid-feedback">
                                        Valid Chassis No is required.
                                    </div>
                                </div>

                                <div class="col-sm-4">
                                    <label for="lastName" class="form-label">Battery KW</label>
                                    <input type="text" class="form-control" id="Battery_kw" name="Battery_kw"
                                        placeholder="Battery KW" value="" required>
                                    <div class="invalid-feedback">
                                        Valid Battery KW is required.
                                    </div>
                                </div>
                            </div>
                        </fieldset>
    ...
    $("#SumInsured, #BUSINESS").bind("change keyup", function(e) {
        ...
        if (num2 == '1.75' || num2 == '2.25') {
            ...
            num4 = num3 * 18 / 100;
            num5 = num3 + num4;
            document.getElementById("results").value = Math.round(num5);
        }
    });
    </script>
</body>
