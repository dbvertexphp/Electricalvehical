             ...
             <?php  if($error=$this->session->flashdata('old_password')){  ?>
               ...
               <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" style="float:right;"></button>
                ...
                <div class="mb-3">
                  ...
                  <input type="password" placeholder="Type your Old password here" class="form-control" name ="oldpassword" id="oldpassword" required>
                </div>
                
                <div class="mb-3">
                  <label for="password" class="form-label">Enter your New Password</label>
                  <input type="password" placeholder="Type your New password here" class="form-control" name ="password" id="password" required>
                </div>
                
                 <div class="mb-3">
                  <label for="password" class="form-label">Enter your confirm Password</label>
                  <input type="password" placeholder="Type your confirm password here" class="form-control" name ="password" id="confirm_password" required>
                </div>
