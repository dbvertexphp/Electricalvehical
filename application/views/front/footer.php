...
<body>
    <div class="container-fluid footer" style="background-color: black;">
        <div class="container" style="padding: 25px 25px;">
            <div class="row" style="color: white;">
                ...
                <div class="col-sm-2 pt-1">
                        <p> <a class="text-white footer_optine" href="<?php echo base_url();?>Fornt/about_us">About Us </a></p>
                         <p> <a class="text-white footer_optine" href="<?php echo base_url();?>Fornt/Privacy_Policy">Privacy Policy</a></p>
                        ...
                        <p> <a class="text-white footer_optine" href="<?php echo base_url();?>Fornt/SHIPPING">Shipping And Delivery</a></p>
                        <p> <a class="text-white footer_optine" href="<?php echo base_url();?>Fornt/Cancellation">Cancellation And Refund</a></p>
                </div>
                <div class="col-sm-2 pt-1">
                    <p>Products</p>
            ...
            <center class="fs-5" style="color:#FA7640;">Developed by <a href="http://dbvertex.com/" style="  text-decoration: none; color:white">DB Vertex Technologies</a></center>
        </div>
    </div>
</body>
</html>