    ...
    <div class="container">
        <div class="row">
          <div class="col-md-6 mb-1" style="padding-right: 85px;">
            <form method="post"  action="<?php echo base_url();?>Fornt/userlogin"  >
                <h3><b>Mobile</b></h3><br>
                <h5>Login</h5>
              <?php  if($error=$this->session->flashdata('login_error')){  ?>
                ...
                <div class="mb-3">
                  ...
                  <input type="email" placeholder="Type your email" class="form-control" id="username" value="<?php if(isset($_COOKIE["email"])) { echo $_COOKIE["email"]; } ?>" name ="email" aria-describedby="emailHelp" required>
                 </div>
                <div class="mb-3">
                  <label for="password" class="form-label">Enter your Password</label>
                  <input type="password" placeholder="Type your password here" class="form-control" value="<?php if(isset($_COOKIE["userpassword"])) { echo $_COOKIE["userpassword"]; } ?>"  name ="password" id="password" required>
                </div>
                 ...
                 <div class="row mb-3">
                    <div class="col ">
                      ...
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox"  value="1" name="Remember"  id="form2Example31"  <?php if(isset($_COOKIE["user_login"])) { ?> checked <?php } ?>  />
                        <label class="form-check-label" for="form2Example31" style="color: #b9b8b8;"> Remember me? </label>
                      </div>
                    </div>
          ...
          <div class="col-md-6" >
            <img src="<?php echo base_url();?>/image/loginimg.png" class="img-fluid" alt="" style="padding: 35px;background-color: #ffb600;">
          </div>
        </div>
      </div><br>
