...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="font-size: 12px;">
                    <div class="row mt-0 text-dark fw-bolder">
                        <h5 style="color:green;">You are Submitting information for the premium Amount.
                            <?php echo $sum_insured;?>, policy start date <?php echo $policy_start;?> </h5>
                    </div>
                    <form method="post" name="myform">


                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border borders w-25 border ">Customer Information </Details>
                            </legend>
                            <div class="control-group General bg-white shadow-sm p-4 ">
                                ...
                                <div class="row ">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Salutation <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <select class="bank_name h-20" id="Salutation" name="Salutation"
                                            style=" border-opacity: 0.7; height:30px;">
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 15px;  color:black;">Name OF Policy Holder <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" value="" id="Policy_Holder" name="Policy_Holder"
                                            type="text">
                                ...
                                <div class="row mt-3">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Gender<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <select class="bank_name h-20" id="Gender" name="Gender"
                                            style=" border-opacity: 0.7; height:30px;">
                                            <option value="">None</option>
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Date OF Birth<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                               ...
                               $data = shop_get($shop_id); 
                               $agent = agent_get($data->agent_id);

                                ?>

                                <div class="row ">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Agent Code <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" value="<?php echo $agent->agent_code; ?>" id="agent_code" name="agent_code"
                                            type="text">
                                        <p id="Policy_Holderlocation" style="color:red"></p>
                                    </div>
                                    <div class="col-2">
                                        <lebel style="font-size: 15px;  color:black;">Shop Code<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" value="<?php echo $data->shop_code; ?>" id="shop_code" name="shop_code"
                                            type="text">
                                        <p id="Policy_Holderlocation" style="color:red"></p>
                                    </div>
                                </div>
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border borders w-25 border ">Communication Address </Details>
                            </legend>
                            <div class="control-group General bg-white shadow-sm p-4  ">

                                <div class="row ">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Address Line 1<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" name="Address_Line_1" id="Address_Line_1" value=""
                                            type="text">
                                        <p id="Address_Line_1location" style="color:red"></p>
                                    </div>
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Address Line 2<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" name="Address_Line_2" id="Address_Line_2" value=""
                                            type="text">
                                ...
                                <div class="row mt-3 ">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Pincode<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">State <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <select class="bank_name h-20" id="State" name="State"
                                            style=" border-opacity: 0.7; height:30px;">
                                            <option value="">None</option>
                                ...
                                <div class="row  mt-3 ">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">City <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Mobile Number<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" name="Mobile" id="Mobile" maxlength="10"
                                ...
                                <div class="row  mt-3">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Email<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border borders w-50 border ">Risk Details To Be Mobile Maker And
                                Dealils</Details>
                                </Details>
                            </legend>
                            <div class="control-group General bg-white shadow-sm p-4 ">
                                ...
                                <div class="row ">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Make<sup
                                                class="text-danger ">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Model <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="row mt-3">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Tear Of Manufacturing<sup
                                                class="text-danger">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" name="Tear_Manufacturing" id="Tear_Manufacturing"
                                            value="" type="text">
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">IMEI No <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="row mt-3">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Model No<sup
                                                class="text-danger">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Serial KW<sup
                                                class="text-danger">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group General bg-white shadow-sm p-4 ">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-4">
                                        <input class="bank_name" name="Addresss_Line_1" id="Addresss_Line_1" value=""
                                            type="text">
                                    ...
                                    <div class="col-4">
                                        <input class="bank_name" name="Addresss_Line_2" id="Addresss_Line_2" value=""
                                            type="text">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;" for="States">State<sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <select class="bank_name h-20" id="States" name="States"
                                            style=" border-opacity: 0.7; height:30px;">
                                            <option value="">None</option>
                                            <option value="Andhra Pradesh">Andhra Pradesh</option>
                                            <option value="Andaman and Nicobar Islands">Andaman and Nicobar Islands
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="control-group General bg-white shadow-sm p-4 ">
                                ...
                                <div class="row ">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Financer Name<sup
                                                class="text-danger ">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <input class="bank_name" id="Financer_Name" name="Financer_Name" value=""
                                            type="text">
                                        <p id="Financer_Namelocation" style="color:red"></p>
                                    </div>
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Address <sup
                                                class="text-danger ml-1 mt-2">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="row mt-3">
                                    <div class="col-2">
                                        <lebel style="font-size: 14px; color:black;">Financer Type<sup
                                                class="text-danger">*</sup></lebel>
                                    </div>
                                    <div class="col-4">
                                        <select class="bank_name h-20" id="Financer_Type" name="Financer_Type"
                                            style=" border-opacity: 0.7; height:30px;">
                                            <option value="">None</option>
                        ...
                        <center>
                            <button class="bg-gradient-primary Calculate Next mr-3"
                                style="width:150px; font-size:15px"><a class="text-white"
                                    href="<?php echo site_url("Welcome/mobile_product");?>">previous</a></button>
                            <button class="Calculate bg-gradient-primary" id="submit"
    ...
    $("#submit").click(function(e) {
        ...
        var shop_code = document.myform.shop_code.value;
        var agent_code = document.myform.agent_code.value;
        ...
        if (Financer_Type == "HYPOTHECATED") {
            if (Address == "") {
                document.getElementById("Addresslocation").innerHTML =
                    "Please enter your financer location";
                status = false;
            } else {
                document.getElementById("Addresslocation").innerHTML = " ";
                status = true;
        ...
        var shop_code_id = $("#shop_code").val();
        var agent_code_id = $("#agent_code").val();
        ...
        $.ajax({
            ...
            url: "<?php echo site_url();?>/Welcome/agent_mobile_user",
            type: 'POST',
            dataType: 'text',
            ...
            data: {
                ...
                Gender: Gender_id,
                Date_Birth: Date_Birth_id,
                Address_Line_1: Address_Line_1_id,
                Address_Line_2: Address_Line_2_id,
                Pincode: Pincode_id,
                State: State_id,
                City: City_id,
                Mobile: Mobile_id,
                ...
                Make: Make_id,
                Model: Model_id,
                Tear_Manufacturing: Tear_Manufacturing_id,
                Battery_No: Battery_No_id,
                Chassis_No: Chassis_No_id,
                Battery_kw: Battery_kw_id,
                Addresss_Line_1: Addresss_Line_1_id,
                Addresss_Line_2: Addresss_Line_2_id,
                Pincodes: Pincodes_id,
                States: States_id,
                Citys: Citys_id,
                Financer_Name: Financer_Name_id,
                Address: Address_id,
                Financer_Type: Financer_Type_id,
                shop_code: shop_code_id,
                agent_code: agent_code_id,
            },
            success: function(data) {
                if (data == "") {
                   window.location = "<?php echo site_url();?>/Welcome/agent_mobile_report";
                }
            }
